...
export class MembershipService {
  ...
  async activateMembership(user: User, dto: MembershipActivateDto): Promise<MembershipDto> {
    if (dto.tier === MembershipTier.Free) {
      throw new BadRequestException('Cannot activate Free tier');
    }
  ...
  async updateMembership(user: User, dto: MembershipUpdateDto): Promise<MembershipDto> {
